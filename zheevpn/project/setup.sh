...
rm -fr menu
rm -fr /usr/sbin/menu
wget https://raw.githubusercontent.com/myzhero/v3/main/zheevpn/project/menu.zip
unzip menu.zip
chmod +x menu/*
...
##### service #####
cd /usr/local/bin
wget https://raw.githubusercontent.com/myzhero/v3/main/zheevpn/project/ws/ws.zip
unzip ws.zip
rm -fr ws.zip
chmod +x *
chmod +x /usr/bin/*
...
wget https://raw.githubusercontent.com/myzhero/v3/main/zheevpn/project/ws/service.zip
unzip service.zip
rm -fr service.zip
...
mkdir /etc/slowdns
cd /etc/slowdns
wget https://raw.githubusercontent.com/myzhero/v3/main/zheevpn/project/dns.zip
unzip dns.zip
chmod +x *
...
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/myzhero/v3/main/zheevpn/project/password"
...
wget -O /etc/nginx/conf.d/xray.conf https://raw.githubusercontent.com/myzhero/v3/main/zheevpn/project/xray.conf
...
<font color="red"><b>           ZheeVPN         </b></font><br>
<font color="blue"><b>===============================</br></font><br>
END
...
wget -O /etc/xray/config.json https://raw.githubusercontent.com/myzhero/v3/main/zheevpn/project/config.json
